...
outputfile = 'hll-waves.' + figformat
...
grid[0].annotate('$\\vec{U}_\\mathrm{L}$', xy=(0.12, 0.5), ha='left', va='top',
				 xycoords='axes fraction', fontsize=24)
grid[0].annotate('$\\vec{U}_{\\star}$', xy=(0.45, 0.5), ha='left', va='top',
				 xycoords='axes fraction', fontsize=24)
grid[0].annotate('$\\vec{U}_\\mathrm{R}$', xy=(0.82, 0.5), ha='left', va='top',
				 xycoords='axes fraction', fontsize=24)
