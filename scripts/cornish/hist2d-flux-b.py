...
if args.harry:
	benstr = "-harry"
outputfile = cornish_data.dirname + '/hist2d-flux-b' + benstr + '.' + figformat
...
counts_0, xedges_0, yedges_0 = np.histogram2d(simulated_survey[:,9], simulated_survey[:,12], bins=(xbins, ybins))
counts_1, xedges_1, yedges_1 = np.histogram2d(cornish_survey[:,9], cornish_survey[:,2], bins=(xbins, ybins))
