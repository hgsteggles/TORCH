...
grid[0].set_ylim([0.0, 15.0])
grid[1].set_ylim([0.0, 15.0])

xbins = np.logspace(0.3, 4.3, 22)
ybins = np.arange(0, 25, 1)

counts_0, xedges_0, yedges_0 = np.histogram2d(simulated_survey[:,9], simulated_survey[:,7], bins=(xbins, ybins))
counts_1, xedges_1, yedges_1 = np.histogram2d(cornish_survey[:, 9], cornish_survey[:,11], bins=(xbins, ybins))
...
grid[0].hist2d(simulated_survey[:,9], simulated_survey[:,7], bins=(xbins, ybins))
grid[0].pcolormesh(xedges_0, yedges_0, np.swapaxes(counts_0, 0, 1))

grid[1].hist2d(cornish_survey[:,9], cornish_survey[:,11], bins=(xbins, ybins))
