...
if args.harry:
	benstr = "-harry"
outputfile = cornish_data.dirname + '/hist2d-flux-l' + benstr + '.' + figformat
...
counts_0, xedges_0, yedges_0 = np.histogram2d(simulated_survey[:,9], simulated_survey[:,11], bins=(xbins, ybins))
counts_1, xedges_1, yedges_1 = np.histogram2d(cornish_survey[:,9], cornish_survey[:,1], bins=(xbins, ybins))
