...
if args.harry:
	benstr = "-harry"
outputfile = cornish_data.dirname + '/hist-tms' + benstr + '.' + figformat
...
grid[0].set_xlabel(plotter.format_label(torch.VarType('t_\mathrm{ms}', units='kyr')))
...
plotter.histstep(grid[0], simulated_survey[:,2], bins, **kx)
