...
plotter.histstep(grid[0], cornish_survey[:,1], bins0, normed=True, errorcentres=bincentres0, **kx1)
plotter.histstep(grid[0], simulated_survey[:,11], bins0, normed=True, **kx2)
plotter.histstep(grid[1], cornish_survey[:,2], bins1, normed=True, errorcentres=bincentres1, **kx1)
plotter.histstep(grid[1], simulated_survey[:,12], bins1, normed=True, **kx2)
plotter.histstep(grid[2], cornish_distances[:,1], bins2, normed=True, errorcentres=bincentres2, **kx1)
plotter.histstep(grid[2], simulated_survey[:,4], bins2, normed=True, **kx2)
