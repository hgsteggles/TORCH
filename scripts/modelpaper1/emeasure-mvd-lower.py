...
xrange = []
xrange.append([190, 260, 380, 800])
xrange.append([140, 190, 300, 500])
xrange.append([120, 150, 280, 400])
xrange.append([100, 120, 180, 250])
xrange.append([80, 100, 150, 190])
...
fancy_grid.save_plot("emeasure-mvd-lower.png")