...
def getSpectralIndices():
	...
	for i in range(45):
		...
		hdu_list0 = fits.open(mp1_data.getRadioDirname(row, col, 25, 45, 1.4) + "/intensity_beam_ff.fits")
		hdu_list1 = fits.open(mp1_data.getRadioDirname(row, col, 25, 45, 5) + "/intensity_beam_ff.fits")
